...
#include <math.h>
#include <fstream>
#include <mowerbot/fdilink_data_struct.h>
...
#define TYPE_GNSS_DUAL_ANT 0x78
...
#define GNSS_DUAL_ANT_LEN 0x86 //134
...
private:
  ...
  FDILink::GNSS_Dual_Ant_frame_read GNSS_Dual_Ant_frame_;
  //frame name
  ...
  string gps_topic_, gnss_dual_ant_topic_, twist_topic_,NED_odom_topic_;

  //Publisher
  ros::Publisher imu_pub_;
  ros::Publisher gps_pub_;
  ros::Publisher gnss_dual_ant_pub_;
